...
import 'package:stacked_example_app/ui/views/validation_example/validation_example_viewmodel.dart';
...
void main() {
  group('ValidationExampleViewmodelTest -', () {
    group('canSubmit -', () {
      ...
      test('When setName is called and mobileNumber is invalid, should be false', () {
        var model = ValidationExampleViewModel();
